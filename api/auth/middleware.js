...
async function initializeDatabase() {
    ...
    `;
        // 创建索引
        await (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_inventory_logs_bean_id ON inventory_logs(bean_id)`;
        await (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_tasting_records_bean_id ON tasting_records(bean_id)`;
        await (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_inventory_logs_date ON inventory_logs(date)`;
        await (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_tasting_records_date ON tasting_records(date)`;
        await (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_coffee_beans_user_id ON coffee_beans(user_id)`;
        await (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_inventory_logs_user_id ON inventory_logs(user_id)`;
        await (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_tasting_records_user_id ON tasting_records(user_id)`;
